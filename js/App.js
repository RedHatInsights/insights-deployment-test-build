...
/******/ 		return __webpack_require__.p + "js/" + ({"ListRules~SamplePage":"ListRules~SamplePage","SamplePage":"SamplePage","Rules":"Rules","ListRules":"ListRules"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 				var href = "css/" + ({"ListRules~SamplePage":"ListRules~SamplePage","SamplePage":"SamplePage","Rules":"Rules","ListRules":"ListRules"}[chunkId]||chunkId) + ".css";
...
/******/ 	__webpack_require__.p = "/insights/";
/******/
...
function buildNavigation() {
    var currentPath = 'advisor' + '/' + window.location.pathname.split('/').slice(-1)[0];
    return [{
        title: 'Sample App',
...
var Rules = (0, _asyncComponent2.default)(function () {
    return __webpack_require__.e(/*! import() | Rules */ "Rules").then(__webpack_require__.t.bind(null, /*! ./PresentationalComponents/Rules/Rules */ "./src/PresentationalComponents/Rules/Rules.js", 7));
});
var SamplePage = (0, _asyncComponent2.default)(function () {
    return Promise.all(/*! import() | SamplePage */[__webpack_require__.e("ListRules~SamplePage"), __webpack_require__.e("SamplePage")]).then(__webpack_require__.t.bind(null, /*! ./SmartComponents/SamplePage/SamplePage */ "./src/SmartComponents/SamplePage/SamplePage.js", 7));
});
var paths = {
    sample: '/samplepage',
    rules: '/advisor/rules'
...
var Routes = exports.Routes = function Routes(props) {
    ...
    return _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(InsightsRoute, { exact: true, path: paths.sample, component: SamplePage, rootClass: 'sample' }),
        ...
        _react2.default.createElement(_reactRouterDom.Route, { render: function render() {
                return (0, _some2.default)(paths, function (p) {
                    return p === path;
                }) ? null : _react2.default.createElement(_reactRouterDom.Redirect, { to: paths.sample });
            } })
    );
};
